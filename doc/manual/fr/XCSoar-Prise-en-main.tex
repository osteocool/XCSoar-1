...
%
\begin{flushright}
Mise à jour du 21 avril 2012 (par Adrien Ott)
\end{flushright}
%
\pagebreak
\noindent
...
%
\noindent
Une fonction utile est l'affichage du \textbf{plan nécessaire} pour rejoindre un aérodrome par exemple (en prenant en compte la hauteur de sécurité configurée). Cette fonction est activable dans "Config. / Config. / Options Système /  Afficher la carte / Eléments / Hauteur d'arrivée", y choisir "Finesse nécessaire".
%
